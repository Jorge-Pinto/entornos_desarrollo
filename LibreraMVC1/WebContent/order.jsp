...
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>Pedido a la librería MVC</title>
</head>
<body>
...
<input type="hidden" name="todo" value="add"> Titulo: <select name=idLibro>
<%
...
+ LibrosBD.getPrecio(i)); out.println("</option>");
}
%>
